...
Vue.component('GovMainWrapper', () => import('@/components/Gov/GovMainWrapper'))
...
Vue.component('GovTableHeader', () => import('@/components/Gov/GovTableHeader'))
...
Vue.component('GovWarningText', () => import('@/components/Gov/GovWarningText'))
...
Vue.mixin({
  ...
  methods: {
    ...
    async fetchAll(uri, params = {}, method = 'get') {
      ...
      const payload = method === 'get' ? { params: mergedParams } : mergedParams
